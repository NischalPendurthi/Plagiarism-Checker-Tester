...
void testcase::get_pre_existing_codes(void) {
    ...
    while (in >> id >> student_name >> professor_name >> code_file) {
        ...
        std::cout << "  id=" << submission->id 
                  << ", student=" << submission->student->get_name()
                  << ", professor=" << submission->professor->get_name() 
                  << ", codefile=" << submission->codefile << std::endl;
...
void testcase::execute_testcase(std::string __test_dir) {
    ...
    std::cout<<"Pre existing submissions: "<<std::endl;
    ...
    while (in >> timestamp >> id >> student_name >> prof_name >> code_file) {
        std::cout<<"Adding Submission......"<<std::endl;
        // std::cout << "  Read values: timestamp=" << timestamp 
        //           << ", id=" << id 
        //           << ", student_name=" << student_name 
        //           << ", prof_name=" << prof_name 
        //           << ", code_file=" << code_file << std::endl;
        std::cout<<std::endl;
        ...
        // std::cout << "  Created submission: id=" << submission->id 
        //           << ", student=" << submission->student->get_name()
        //           << ", professor=" << submission->professor->get_name() 
        //           << ", codefile=" << submission->codefile << std::endl;
        // std::cout<<std::endl;
